### MACOSX RUN qmake circlecoin-qt.pro FROM COMMAND LINE, NOT CREATOR ###
...
#   Bracket the code to profile with ProfileStart("circlecoin-qt.prof") and ProfileStop() and recompile
#   Run circlecoin-qt through its paces then exit
#   Analyze with:
#      pprof ./circlecoin-qt circlecoin-qt.prof
#   For a graphical view you need to: sudo apt-get install graphviz gv
#   Then run:
#      pprof --gv ./circlecoin-qt circlecoin-qt.prof
PROFILE = 0
...
OPENSSL_INCLUDE_PATH=D:/deps/openssl-1.0.1m/include
OPENSSL_LIB_PATH=D:/deps/openssl-1.0.1m
...
FORMS += \
    ...
    src/qt/forms/getcirclecoinpage.ui \
...
macx:ICON = src/qt/res/icons/circlecoin.icns
